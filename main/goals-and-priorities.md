...
**Negócio:**
- Aprofundar o conhecimento das áreas de negócio impactadas pelos use cases que estou a gerir.

**Técnico:**
- Leitura diária sobre novidades no mundo de IA.
- Aprofundar conhecimentos em APIs — nomeadamente Apigee e Apigee X.
- MCP Servers.
- Agentic AI.

## Objetivo de Longo Prazo (1-2 anos)

Ser uma referência na DSI em termos de estratégia de IA.

## Como faço tradeoffs

Procuro o meio-termo entre velocidade e qualidade — não sacrifico um pelo outro de forma absoluta.

## O que não estou a priorizar agora

Nada deliberadamente em pausa neste momento.
